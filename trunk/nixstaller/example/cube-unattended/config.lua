-- Automaticly generated on za mrt  7 21:18:12 CET 2009.
...
cfg.languages = { "english", "dutch", "lithuanian", "bulgarian" }
...
cfg.unopts["script"] = { desc = "Installs a startup script to your home directory.", short = "s" }
