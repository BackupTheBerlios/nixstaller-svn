...
# src/README.txt 0.96.91.D001 2005/09/08 09:14:36 knight
...
In this case, your options are:
    ...
    --  (Recommended.)  Install from a pre-packaged SCons package that
        does not require distutils:
            ...
            Red Hat Linux       scons-0.96.91-1.noarch.rpm

            Debian GNU/Linux    scons_0.96.91-1_all.deb
                                (or use apt-get)

            Windows             scons-0.96.91.win32.exe
...
By default, the above command will do the following:
    ...
    --  Install the version-numbered "scons-0.96.91" and "sconsign-0.96.91"
    ...
    --  Install scripts named "scons" and "sconsign" scripts in the
        ...
        symbolic links to the "scons-0.96.91" and "sconsign-0.96.91" scripts
        by specifying the "--hardlink-scons" or "--symlink-scons"
        options on the command line.

    --  Install "scons-0.96.91.bat" and "scons.bat" wrapper scripts in the
        Python prefix directory on Windows (C:\Python*, for example).
        This can be disabled by specifying the "--no-install-bat" option
        on the command line.  On UNIX or Linux systems, the
        "--install-bat" option may be specified to have "scons-0.96.91.bat"
    ...
    --  Install the SCons build engine (a Python module) in an
        ...
        (/usr/lib/scons-0.96.91 or C:\Python*\scons-0.96.91, for example).
