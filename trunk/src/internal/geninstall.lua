...
function PrepareArchive()
    ...
    RequiredCopy(curdir .. "/src/internal/packagedirscreen.lua", confdir .. "/tmp")
    RequiredCopy(curdir .. "/src/internal/packagetogglescreen.lua", confdir .. "/tmp")
    ...
    RequiredCopy(curdir .. "/src/internal/utils.lua", confdir .. "/tmp")
    ...
    RequiredCopy(curdir .. "/src/internal/pkg/pacman.lua", confdir .. "/tmp")
