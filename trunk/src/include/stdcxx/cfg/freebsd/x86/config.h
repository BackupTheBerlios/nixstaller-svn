// configured for gcc-3.4.6 on FreeBSD 6.2-RC1
...
#define _RWSTD_LDBL_QNAN_BITS  { 0, 0, 0, 0, 0, 0, 0, '\xc0', '\xff', '\xff', '\x5', '\x28' }
#define _RWSTD_LDBL_SNAN_BITS  { '\x1', 0, 0, 0, 0, 0, 0, '\x80', '\xff', '\x7f', '\x5', '\x28' }
#define _RWSTD_LDBL_DENORM_MIN_BITS  { 0, '\x8', 0, 0, 0, 0, 0, 0, 0, 0, '\x5', '\x28' }
...
#define _RWSTD_OS_RELEASE "6.2-RC1"
#define _RWSTD_OS_VERSION "FreeBSD 6.2-RC1 #0: Thu Nov 16 05:12:08 UTC 2006     root@opus.cse.buffalo.edu:/usr/obj/usr/src/sys/SMP"
#define _RWSTD_OS_MAJOR 6
#define _RWSTD_OS_MINOR 2
#define _RWSTD_OS_MICRO 1
...
#define _RWSTD_OFF_T long long   // off_t
