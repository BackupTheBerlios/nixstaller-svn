// configured for gcc-3.4.6 on FreeBSD 7.1-RELEASE
...
#define _RWSTD_NO_LDEXPF_IN_LIBM
...
#define _RWSTD_NO_ACOSL_IN_LIBM
...
#define _RWSTD_LDBL_MAX         1.1897314953572317650E+4932L
...
#define _RWSTD_LDBL_QNAN_BITS  { 0, 0, 0, 0, 0, 0, 0, '\xc0', '\xff', '\xff', 0, 0, 0, 0, 0, 0 }
...
#define _RWSTD_MB_LEN_MAX    6   /* libc value */
...
#define _RWSTD_CAT_5(pfx) { 6, "LC_MESSAGES", pfx::_C_messages }
...
#define _RWSTD_CLOCKS_PER_SEC 128
#define _RWSTD_RAND_MAX       2147483647
#define _RWSTD_EOF            -1
#define _RWSTD_WEOF           -1
#define _RWSTD_L_TMPNAM       1024
...
#define _RWSTD_TMP_MAX        308915776
...
#define _RWSTD_SIG_ATOMIC_T   long
#define _RWSTD_SIG_ATOMIC_MIN _RWSTD_LONG_MIN
#define _RWSTD_SIG_ATOMIC_MAX _RWSTD_LONG_MAX
...
#define _RWSTD_OS_FREEBSD
#define _RWSTD_OS_SYSNAME "FREEBSD"
#define _RWSTD_OS_RELEASE "7.1-RELEASE"
#define _RWSTD_OS_VERSION "FreeBSD 7.1-RELEASE #0: Thu Jan  1 08:58:24 UTC 2009     root@driscoll.cse.buffalo.edu:/usr/obj/usr/src/sys/GENERIC"
#define _RWSTD_OS_MAJOR 7
#define _RWSTD_OS_MINOR 1
#define _RWSTD_OS_MICRO 7
